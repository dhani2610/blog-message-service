                        ...
                        <div class="weekly2-news-active dot-style d-flex dot-style">
                            ...
                            <div class="weekly2-single">
                                <div class="weekly2-img">
                                    <img src="{{ asset($post->image) }}" alt="" width="150" height="130" style="object-fit: cover;">
                                </div>
                        ...
                        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p style="font-size: 1.2rem; color: #666;">Segera kembali dengan berita populer terbaru. Tunggu apalagi? Perburuanlah ke halaman ini lagi!</p>
                                </div>
                            </div>
                        </div>
                    </div>
