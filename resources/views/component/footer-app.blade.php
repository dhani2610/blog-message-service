<footer class="footer">
            ...
            <div>
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block"> Pengembang: <a href="https://irhamkaramann.my.id/" target="_blank">Jdeva Production</a></span>
            </div>
          </footer>
